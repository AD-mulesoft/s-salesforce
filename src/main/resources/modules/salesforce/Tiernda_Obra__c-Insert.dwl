...
var tipo7 = (vars.sfTipo filter (value,index) -> (vars.sfRecord.Ramo__c == value.Valor_Salesforce__c and value.Tipo__c == "7"))[0].Valor_SAP__c default ""
...
var tipo10 = (vars.sfTipo filter (value,index) -> (vars.sfRecord.Incoterms_c__c == value.Valor_Salesforce__c and value.Tipo__c == "10"))[0].Valor_SAP__c default ""
var tipo111 = (vars.sfTipo filter (value,index) -> (vars.sfRecord.Grupo_de_Clientes__c == value.Valor_Salesforce__c and value.Tipo__c == "11"))[0].Valor_SAP__c default ""
...
var tipo19 = (vars.sfTipo filter (value,index) -> (vars.sfRecord.Grupo_de_imputaci_n__c == value.Valor_Salesforce__c and value.Tipo__c == "19"))[0].Valor_SAP__c default ""
...
---
{
    ...
    "Cod_Cliente_Cuenta__c": vars.sfRecord.Cod_Cliente_Cuenta__c,
    ...
    "Grupo_de_Clientes__c": tipo111,
    "Grupo_de_Clientes__c_original": vars.sfRecord.Grupo_de_Clientes__c,
