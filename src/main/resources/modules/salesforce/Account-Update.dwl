...
var tipo7 = (vars.sfTipo filter (value,index) -> (vars.sfRecord.Ramo_c__c == value.Valor_Salesforce__c and value.Tipo__c == "7"))[0].Valor_SAP__c default "ELIMINAR"
...
var tipo111 = (vars.sfTipo filter (value,index) -> (vars.sfRecord.Grupo_de_cliente__c == value.Valor_Salesforce__c and value.Tipo__c == "11"))[0].Valor_SAP__c default "ELIMINAR"
...
---
{
    ...
    "Ramo_c__c": if(vars.sfRecord.Ramo_c__c? and isEmpty(vars.sfRecord.Ramo_c__c)) "ELIMINAR" else if(!isEmpty(vars.sfRecord.Ramo_c__c)) tipo7 else "",
    ...
    "Grupo_de_cliente__c": if(vars.sfRecord.Grupo_de_cliente__c? and isEmpty(vars.sfRecord.Grupo_de_cliente__c)) "ELIMINAR" else if(!isEmpty(vars.sfRecord.Grupo_de_cliente__c)) tipo111 else "",
    ...
    "Clasificaci_n_ABC__c": if(vars.sfRecord.Clasificaci_n_ABC__c? and isEmpty(vars.sfRecord.Clasificaci_n_ABC__c)) "ELIMINAR" else vars.sfRecord.Clasificaci_n_ABC__c default ""
}